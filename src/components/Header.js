...
export default function Header (props) {
  ...
  let smallWidth = 868;
  return (
    <header className="fixed top-8 left-0 right-0 max-w-[1500px] w-[90%] h-20 py-4 px-[2%] lg:px-[5%] bg-text-color-dark/90 dark:bg-text-color/90 z-[100] mx-auto rounded-full flex items-center justify-between text-nowrap">
        <div>
